...
p_norm = 2;
r_factor = 4;
[idx1, samp_str_id1] = cil_sph2_2level(N, nbr_samples, p_norm, r_factor);
...
for vm = vanishing_moments
    ...
    for i = 1:length(sampling_pattern);
        ...
        fname = fullfile(dest, sprintf('%s_had_wave_%s_db%d_non_flipped', ...
                                                test_str_id, samp_str_id, vm));
        [im_rec_non_flipped, wave_rec] = cil_sample_walsh_wavelet(im, sigma, idx, ...
                                                    fname, vm);
        ...
        fname = fullfile(dest, sprintf('%s_had_wave_%s_db%d_flipped', ...
                         test_str_id, samp_str_id, vm));
        [im_rec, wave_rec_flipped] = cil_sample_walsh_wavelet(im_flipped, ...
                                     sigma, idx, fname, vm); %TODO
